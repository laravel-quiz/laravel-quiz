...
!(function(t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		? (module.exports = e())
		: 'function' == typeof define && define.amd ? define(e) : ((t = t || self).Cropper = e());
})(this, function() {
	'use strict';
	function e(t) {
		return (e =
	...
	var Yt = {
			...
			initCanvas    : function() {
				var t = this.containerData,
					...
					s = t.height;
				t.height * r > t.width
					? 3 === i ? (h = t.height * r) : (s = t.width / r)
					: 3 === i ? (s = t.width / r) : (h = t.height * r);
			...
			renderImage   : function(t) {
				...
				ht(i, { width: a, height: n, left: (e.width - a) / 2, top: (e.height - n) / 2 }),
					dt(
						this.image,
						ht({ width: i.width, height: i.height }, Et(ht({ translateX: i.left, translateY: i.top }, i)))
					),
					t && this.output();
			},
			...
			limitCropBox  : function(t, e) {
				...
				if (t) {
					...
					(s = Math.min(s, a.width)),
						...
						h &&
							(s && c ? (s < c * h ? (c = s / h) : (s = c * h)) : s ? (c = s / h) : c && (s = c * h),
							l < d * h ? (d = l / h) : (l = d * h)),
		...
		Xt = {
			...
			preview      : function() {
				...
				this.cropped &&
					!this.disabled &&
					(dt(this.viewBoxImage, ht({ width: l, height: d }, Et(ht({ translateX: -p, translateY: -u }, h)))),
					rt(this.previews, function(t) {
						var e = vt(t, g),
							i = e.width,
							a = e.height,
			...
			wheel     : function(t) {
				...
				this.disabled ||
					...
					this.wheeling ||
						...
						t.deltaY
							? (a = 0 < t.deltaY ? 1 : -1)
							: t.wheelDelta ? (a = -t.wheelDelta / 120) : t.detail && (a = 0 < t.detail ? 1 : -1),
						this.zoom(-a * i, t)));
			},
				...
				switch (h) {
					...
					case L:
						if (s) {
							...
							x(N),
								x(E),
								M.x <= 0
									? g < c ? ((d -= M.x), (c += M.x)) : M.y <= 0 && l <= f && (b = !1)
									: ((d -= M.x), (c += M.x)),
								M.y <= 0 ? f < l && ((p -= M.y), (l += M.y)) : ((p -= M.y), (l += M.y));
						d < 0 && p < 0
							? ((h = z), (l -= p = -p), (c -= d = -d))
							: d < 0 ? ((h = H), (c -= d = -d)) : p < 0 && ((h = Y), (l -= p = -p));
						break;
					case Y:
						if (s) {
							if (M.x <= 0 && (c <= g || w <= m)) {
							...
							x(W),
								x(E),
								M.x <= 0
									? g < c ? ((d -= M.x), (c += M.x)) : 0 <= M.y && w <= m && (b = !1)
									: ((d -= M.x), (c += M.x)),
								0 <= M.y ? m < w && (p += M.y) : (p += M.y);
						d < 0 && p < 0
							? ((h = H), (l -= p = -p), (c -= d = -d))
							: d < 0 ? ((h = z), (c -= d = -d)) : p < 0 && ((h = L), (l -= p = -p));
						break;
					case z:
						if (s) {
							if (0 <= M.x && (v <= u || w <= m)) {
					...
					case B:
						...
						(e = Dt(this.cropper)),
							...
							M.y < 0 && (l -= p),
							this.cropped ||
								(ut(this.cropBox, X), (this.cropped = !0), this.limited && this.limitCropBox(!0, !0));
				}
				b &&
					((o.width = d), (o.height = p), (o.left = c), (o.top = l), (this.action = h), this.renderCropBox()),
					rt(r, function(t) {
		...
		jt = {
			...
			destroy          : function() {
				...
				return (
					t[l] &&
						((t[l] = void 0), this.isImg && this.replaced && (t.src = this.originalUrl), this.uncreate()),
					this
				);
			},
			move             : function(t, e) {
			...
			moveTo           : function(t, e) {
				...
				return (
					...
					this.ready &&
						...
						(F(t) && ((a.left = t), (n = !0)), F(i) && ((a.top = i), (n = !0)), n && this.renderCanvas(!0)),
					this
				);
			},
			zoom             : function(t, e) {
				var i = this.canvasData;
				return (
					(t = (t = Number(t)) < 0 ? 1 / (1 - t) : 1 + t), this.zoomTo(i.width * t / i.naturalWidth, null, e)
				);
			},
			zoomTo           : function(t, e, i) {
				...
				if (0 <= (t = Number(t)) && this.ready && !this.disabled && a.zoomable) {
					...
					if (i) {
						...
						it(e) && F(e.x) && F(e.y)
							? ((n.left -= (c - o) * ((e.x - n.left) / o)), (n.top -= (l - r) * ((e.y - n.top) / r)))
			...
			getCropBoxData   : function() {
				var t,
					e = this.cropBoxData;
				return (
					this.ready && this.cropped && (t = { left: e.left, top: e.top, width: e.width, height: e.height }),
					t || {}
				);
			},
