                                    ...
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('users.edit',['id' => $user->id ]) }}" data-toggle="tooltip" data-placement="top" title="Edit" style="float:left; margin-top:5px;"><span class="btn btn-info"><i class="fa fa-pencil color-muted m-r-5"></i></span></a>
