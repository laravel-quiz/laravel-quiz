                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{ route('users.destory',['id' => $user->id]) }}" style="float:center;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" onclick="return confirm('Are you sure?')" data-toggle="tooltip" data-placement="top" title="Delete"><span class="btn btn-info"><i class="fa fa-trash color-muted m-r-5"></i></span></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
