...
Route::middleware(['auth','role'])->prefix('/admin')->group(function(){
    ...
    Route::get('/category','IncorrectAnswerController@index')->name('incorrectanswer');
    Route::get('/category/create','IncorrectAnswerController@create')->name('incorrectanswer.create');
    Route::post('/category/store','IncorrectAnswerController@store')->name('incorrectanswer.store');
    Route::get('/category/{id}/edit','IncorrectAnswerController@edit')->name('incorrectanswer.edit');
    Route::put('/category/{id}','IncorrectAnswerController@update')->name('incorrectanswer.update');
    Route::get('/category/{id}','IncorrectAnswerController@show')->name('incorrectanswer.show');
    Route::delete('/category/{id}','IncorrectAnswerController@destroy')->name('incorrectanswer.destroy');
});
