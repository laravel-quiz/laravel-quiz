...
use App\Services\QuestionAnswerServices;
...
class QuestionAnswerController extends Controller
{
    ...
    {
        $this->questionAnswerServices = $questionAnswerServices;
    }
    public function index()
    {
        $quizes = $this->questionAnswerServices->get();
    ...
    {
        $categories = Category::all()->orderBy('desc');
